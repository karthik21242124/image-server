...
int main(int argc, char **argv) 
{
   ...
   FILE *fp = fopen("college.png","rb");
    ...
    fclose(fp);
	    ...
	    Mat img = imread("college_gray.png", IMREAD_UNCHANGED);
	    namedWindow( "college_gray.png", WINDOW_AUTOSIZE );
	    imshow( "college_gray.png", img );

    	    Mat img1 = imread("college.png", IMREAD_UNCHANGED);
	    namedWindow( "college.png", WINDOW_AUTOSIZE );
